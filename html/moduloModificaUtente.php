...
if (isset($_SESSION['collegato'])){
    ...
    print '<input type="text" name="nome" class="obbligatorio" value="' . $dati[0]['nome'] . '"></input><br /> ';
    print '<div class="label"><label >Cognome</label></div>';
    print '<input type="text" name="cognome" class="obbligatorio" value="' . $dati[0]['cognome'] . '"></input><br /> ';
    print '<div class="label"><label >Data Nascita</label></div>';
    print '<input type="text" name="datanascita" value="'.$dati[0]['datanascita'].'" class="obbligatorio" id="calendario"></input><br/>';
    print '<div class="label"><label >Indirizzo</label></div>';
    print '<input type="text" name="indirizzo" class="obbligatorio" value="' . $dati[0]['indirizzo'] . '"></input><br /> ';
    ...
    print '<input type="password" name="password" class="obbligatorio" value="' . $dati[0]['psw'] . '"></input><br /> ';
    print '<input type="submit" class="invia" value="Conferma"></input>';
    print '</fieldset>';
    print '</form>';
